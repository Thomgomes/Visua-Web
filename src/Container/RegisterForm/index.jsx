...
export default function RegisterForm({ onClose }) {
  ...
  return (
    ...
    >
      <div
        className="min-w-80 bg-Visua-Form px-8 py-10 rounded-3xl shadow-lg relative"
      ...
      >
        ...
        <form>
          ...
          <Link className="w-full flex justify-center text-base underline hover:text-Visua-Blue transition duration-200">
            Já tem uma conta?
          </Link>
        </form>
        <button
